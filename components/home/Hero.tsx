        ...
        <div className='grid grid-cols-12 grid-rows-2 gap-8 max-md:gap-4'> 
            <Link href={`/blog/${item1.id}`} className='col-span-8 row-span-2 max-[990px]:col-span-12 max-sm:col-span-12'>
                <div className='relative overflow-hidden rounded-lg'>
                    ...
                    />
                    <div className="bg-blackOverlay h-full absolute bottom-[-15%] max-sm:bottom-0 hover:bottom-0 transition-all duration-300 left-0 flex items-end pb-6">
                        <div className="px-8">
                            ...
                            <p className="text-lg max-md:text-md py-2  max-md:leading-[24px] max-sm:text-[14px] max-sm:py-1">
                            {item1.description}
                            </p>
